...
#文本增强
    ...
    #             "googlenews_S_trans_subst_10", "tweet_trans_subst_10"]
    #
    # for dataset in datasets:
    #     augment_files(datadir=datadir, targetdir=targetdir, dataset=dataset, aug_p=0.1, augtype="charswap")
    #
    # datasets = ["agnews_trans_subst_20", "searchsnippets_trans_subst_20", "stackoverflow_trans_subst_20",
    #             "biomedical_trans_subst_20", "googlenews_TS_trans_subst_20", "googlenews_T_trans_subst_20",
    #             "googlenews_S_trans_subst_20", "tweet_trans_subst_20"]
    #
    # for dataset in datasets:
    #     augment_files(datadir=datadir, targetdir=targetdir, dataset=dataset, aug_p=0.2, augtype="charswap")
